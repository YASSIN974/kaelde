 ...
 * </ul>
 * <p>
 * Additionally, if specified in the {@link KyokoPaginator.Builder}, two "bulk skip" reactions
 ...
 * @author John Grosh
 */
public class KyokoPaginator extends Menu {
    ...
    KyokoPaginator(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit,
                   ...
                   boolean wrapPageEnds, String leftText, String rightText, String topText, String bottomText, boolean allowTextInput) {
     ...
     * KyokoPaginator#paginate(MessageChannel, int)
     ...
     * {@link KyokoPaginator#paginate(Message, int) Paginator#paginate(Message, int)}.
     *
    ...
    private Message renderPage(int pageNum) {
        ...
        if (columns == 1) {
            ...
            sbuilder.append(topText);

            for (int i = start; i < end; i++)
                sbuilder.append("\n").append(numberItems ? "`" + (i + 1) + ".` " : "").append(strings.get(i));

            sbuilder.append(bottomText);
     ...
     * a {@link KyokoPaginator Paginator}.
     *
     * @author John Grosh
     */
    public static class Builder extends Menu.Builder<KyokoPaginator.Builder, KyokoPaginator> {
        ...
        /**
         * Builds the {@link KyokoPaginator Paginator}
         * with this Builder.
         *
         ...
         */
        @Override
        public KyokoPaginator build() {
            Checks.check(waiter != null, "Must set an EventWaiter");
            Checks.check(!strings.isEmpty(), "Must include at least one item to paginate");

            return new KyokoPaginator(waiter, users, roles, timeout, unit, color, text, finalAction,
                    columns, itemsPerPage, showPageNumbers, numberItems, strings, waitOnSinglePage,
                    bulkSkipNumber, wrapPageEnds, textToLeft, textToRight, topText, bottomText, allowTextInput);
        }
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setColor(Color color) {
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setColor(BiFunction<Integer, Integer, Color> colorBiFunction) {
         ...
         * when the {@link KyokoPaginator Paginator} is built.
         * <p>
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setText(String text) {
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setText(BiFunction<Integer, Integer, String> textBiFunction) {
         ...
         * {@link KyokoPaginator Paginator} times out.
         *
         * @param finalAction The Consumer action to perform if the Paginator times out
         * @return This builder
         */
        public KyokoPaginator.Builder setFinalAction(Consumer<Message> finalAction) {
            this.finalAction = finalAction;
            return this;
        }
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setColumns(int columns) {
         ...
         */
        public KyokoPaginator.Builder setItemsPerPage(int num) {
            if (num < 1)
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder showPageNumbers(boolean show) {
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder useNumberedItems(boolean number) {
            this.numberItems = number;
            return this;
        }

        /**
         * Sets whether the {@link KyokoPaginator Paginator} will instantly
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder waitOnSinglePage(boolean wait) {
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder clearItems() {
            strings.clear();
            return this;
        }
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder addItems(String... items) {
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setItems(String... items) {
            strings.clear();
            strings.addAll(Arrays.asList(items));
            return this;
        }
        ...
        /**
         * Sets the {@link KyokoPaginator Paginator}'s bulk-skip
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder setBulkSkipNumber(int bulkSkipNumber) {
            this.bulkSkipNumber = Math.max(bulkSkipNumber, 1);
            return this;
        }

        /**
         * Sets the {@link KyokoPaginator Paginator} to wrap
         ...
         * @return This builder
         */
        public KyokoPaginator.Builder wrapPageEnds(boolean wrapPageEnds) {
            this.wrapPageEnds = wrapPageEnds;
            return this;
        }

        public KyokoPaginator.Builder setLanguage(Language language) {
            this.language = language;
            return this;
        }

        public KyokoPaginator.Builder setTopText(String topText) {
            this.topText = topText;
            return this;
        }

        public KyokoPaginator.Builder setBottomText(String bottomText) {
            this.bottomText = "\n" + bottomText;
            return this;
        }
    }
