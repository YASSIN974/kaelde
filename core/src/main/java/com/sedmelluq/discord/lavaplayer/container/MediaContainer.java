...
import com.sedmelluq.discord.lavaplayer.container.module.IbxmContainerProbe;
import com.sedmelluq.discord.lavaplayer.container.module.XmpContainerProbe;
...
public enum MediaContainer {
    ...
    XMP(new XmpContainerProbe()),
    IBXM(new IbxmContainerProbe());
