...
public class AudioManagerImpl implements AudioManager
{
    ...
    protected VideoSendHandler videoSendHandler;
...
//            throw new UnsupportedOperationException("Sorry! Audio is disabled due to an internal JDA error! Contact Dev!");
    ...
    public void setVideoSendingHandler(VideoSendHandler handler) {
        videoSendHandler = handler;
        if (audioConnection != null)
            audioConnection.setVideoSendingHandler(handler);
    }

    @Override
    public VideoSendHandler getVideoSendingHandler() {
        return videoSendHandler;
    }
    ...
    public void setAudioConnection(AudioConnection audioConnection)
    {
        ...
        audioConnection.setVideoSendingHandler(videoSendHandler);
