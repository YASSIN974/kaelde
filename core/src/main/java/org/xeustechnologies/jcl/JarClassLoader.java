...
public class JarClassLoader extends AbstractClassLoader {
    ...
    public void add(InputStream jarStream) {
        classpathResources.loadJar( null, jarStream, true );
    }
    ...
    public void close() {
        Set<String> resources = new HashSet<>(classpathResources.getResources().keySet());
        resources.forEach(classpathResources::unload);
    }
