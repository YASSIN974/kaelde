...
public class EmbedBuilder
{
    ...
    public EmbedBuilder(MessageEmbed embed)
    {
        if(embed != null)
        {
            ...
            this.provider = embed.getSiteProvider();
    ...
    public MessageEmbed build()
    {
        ...
        return EntityBuilder.createMessageEmbed(url, title, descrip, EmbedType.RICH, timestamp,
                color, thumbnail, provider, author, videoInfo, footer, image, new LinkedList<>(fields));
    }
     ...
     * {@link EmbedBuilder#EmbedBuilder(net.dv8tion.jda.core.entities.MessageEmbed) EmbedBuilder(MessageEmbed)}
     * constructor or via the
     * {@link EmbedBuilder#addField(net.dv8tion.jda.core.entities.MessageEmbed.Field) addField} methods.
     *
     * @return the builder after the field has been added
     */
    ...
    public EmbedBuilder setVideo(String url, int width, int height) {
        ...
        videoInfo = new MessageEmbed.VideoInfo(url, width, height);
        return this;
    }

    public EmbedBuilder setSiteProvider(String name, String url) {
        if (name == null || url == null)
            return this;

        provider = new MessageEmbed.Provider(name, url);
        return this;
    }
}
