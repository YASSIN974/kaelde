 ...
 *
 * <p>A single KyokoJDABuilder can be reused multiple times. Each call to
...
public class KyokoJDABuilder {
    ...
    /**
     * Creates a completely empty KyokoJDABuilder.
     ...
     */
    public KyokoJDABuilder(AccountType accountType) {
     ...
     */
    public KyokoJDABuilder setContextMap(ConcurrentMap<String, String> map) {
        this.contextMap = map;
        if (map != null)
     ...
     */
    public KyokoJDABuilder setContextEnabled(boolean enable) {
     ...
     */
    public KyokoJDABuilder setCompressionEnabled(boolean enable) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setRequestTimeoutRetry(boolean retryOnTimeout) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setToken(String token) {
        this.token = token;
        return this;
    }
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setHttpClientBuilder(OkHttpClient.Builder builder) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setWebsocketFactory(WebSocketFactory factory) {
     ...
     */
    public KyokoJDABuilder setCorePoolSize(int size) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setAudioEnabled(boolean enabled) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setBulkDeleteSplittingEnabled(boolean enabled) {
     ...
     * @return Return the {@link net.dv8tion.jda.core.JDABuilder KyokoJDABuilder } instance. Useful for chaining.
     */
    public KyokoJDABuilder setEnableShutdownHook(boolean enable) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setAutoReconnect(boolean autoReconnect) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setEventManager(IEventManager manager) {
     ...
     * @return The KyokoJDABuilder instance. Useful for chaining.
     */
    public KyokoJDABuilder setAudioSendFactory(IAudioSendFactory factory) {
     ...
     */
    public KyokoJDABuilder setIdle(boolean idle) {
        this.idle = idle;
        return this;
    }
     ...
     */
    public KyokoJDABuilder setGame(Game game) {
        this.game = game;
        return this;
    }
     ...
     */
    public KyokoJDABuilder setStatus(OnlineStatus status) {
     ...
     */
    public KyokoJDABuilder addEventListener(Object... listeners) {
     ...
     */
    public KyokoJDABuilder removeEventListener(Object... listeners) {
        Checks.noneNull(listeners, "listeners");
     ...
     */
    public KyokoJDABuilder setMaxReconnectDelay(int maxReconnectDelay) {
     ...
     */
    public KyokoJDABuilder useSharding(int shardId, int shardTotal) {
     ...
     * for this KyokoJDABuilder instance. This can be used to sync behaviour and state between shards
     ...
     */
    public KyokoJDABuilder setSessionController(SessionController controller) {
        this.controller = controller;
        return this;
    }

    public KyokoJDABuilder setGateway(String gateway) {
    ...
    public JDA buildAsync() throws LoginException {
        ...
        String gateway = this.gateway == null ? jda.getGateway() : this.gateway;
